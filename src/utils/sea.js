...
(function() {
    ...
    if (typeof window !== "undefined") {
      ...
      Object.assign(api, {
        ...
        random: function random(len) {
          return Buffer.from(
            crypto.getRandomValues(new Uint8Array(Buffer.alloc(len)))
          );
        }
      });
    } else {
  ...
  USE(function(module) {
    ...
    var sha256hash = (function() {
      var _ref = _asyncToGenerator(
        /*#__PURE__*/ regeneratorRuntime.mark(function _callee(mm) {
          var m, hash;
              ...
              while (1) {
                switch ((_context.prev = _context.next)) {
                  case 0:
                    m = parse(mm);
                    _context.next = 3;
                    return shim.subtle.digest(
                      { name: pbkdf2.hash },
                      new shim.TextEncoder().encode(m)
                    );
                ...
                while (1) {
                  switch ((_context2.prev = _context2.next)) {
                    ...
                    case 9:
                      ...
                      rsha = _context2.t0.from
                        .call(_context2.t0, _context2.t1, "binary")
                        .toString("utf8");
                    ...
                    case 13:
                      _context2.next = 15;
                      return (shim.ossl || shim.subtle).importKey(
                        "raw",
    ...
    SEA.pair =
      ...
      (function() {
        var _ref3 = _asyncToGenerator(
          /*#__PURE__*/ regeneratorRuntime.mark(function _callee5(cb) {
                  ...
                  switch ((_context5.prev = _context5.next)) {
                    ...
                    case 15:
                      if (
                        !(
                          _context5.t0 ==
                          "Error: ECDH is not a supported algorithm"
                        )
                      ) {
                        _context5.next = 19;
                        break;
                  ...
                  switch ((_context6.prev = _context6.next)) {
                    ...
                    case 13:
                      ...
                      r =
                        ...
                        JSON.stringify({
                          m: msg,
                          s: shim.Buffer.from(sig, "binary").toString("utf8")
                        });
              ...
              while (1) {
                switch ((_context8.prev = _context8.next)) {
                  ...
                  case 5:
                    ...
                    hash = _context8.t0.from.call(
                      _context8.t0,
                      _context8.t1,
                      "binary"
                    );
                    _context8.next = 9;
                    return shim.subtle.importKey(
                      "raw",
                      new Uint8Array(hash),
                      opt.name || "AES-GCM",
                      false,
                  ...
                  switch ((_context9.prev = _context9.next)) {
                    case 0:
                      ...
                      return aeskey(key, rand.s, opt).then(function(aes) {
                        return /*shim.ossl ||*/ shim.subtle.encrypt(
                          {
                ...
                while (1) {
                  switch ((_context10.prev = _context10.next)) {
                    case 0:
                      ...
                      return aeskey(
                        key,
                        shim.Buffer.from(json.s, "utf8"),
                        opt
                      ).then(function(aes) {
                        return /*shim.ossl ||*/ shim.subtle.decrypt(
                          {
                            // Keeping aesKey scope as private as possible...
                            name: opt.name || "AES-GCM",
                            iv: new Uint8Array(
                              shim.Buffer.from(json.iv, "utf8")
                            )
                          },
                          aes,
                          new Uint8Array(shim.Buffer.from(json.ct, "utf8"))
                        );
                      });
                ...
                while (1) {
                  switch ((_context12.prev = _context12.next)) {
                    case 0:
                      ...
                      _context12.next = 10;
                      return ecdhSubtle.importKey.apply(
                        ecdhSubtle,
                        _toConsumableArray(pubKeyData).concat([true, []])
                      );
                    ...
                    case 10:
                      ...
                      props = _context12.t0.assign.call(
                        _context12.t0,
                        _context12.t1,
                        _context12.t3
                      );
                      ...
                      _context12.next = 16;
                      return ecdhSubtle.importKey
                        .apply(
                          ecdhSubtle,
                          _toConsumableArray(privKeyData).concat([
                            false,
                            ["deriveKey"]
                          ])
                        )
    ...
    SEA.keyid =
      ...
      (function() {
        var _ref14 = _asyncToGenerator(
          /*#__PURE__*/ regeneratorRuntime.mark(function _callee13(pub) {
            var pb, id, sha1, hash;
            return regeneratorRuntime.wrap(
                  ...
                  switch ((_context13.prev = _context13.next)) {
                    ...
                    case 5:
                      ...
                      return _context13.abrupt(
                        "return",
                        hash.toString("hex", hash.length - 8)
                      );
    ...
    var updateStorage = function updateStorage(proof, key, pin) {
      return (function() {
        var _ref17 = _asyncToGenerator(
          /*#__PURE__*/ regeneratorRuntime.mark(function _callee16(props) {
              ...
              while (1) {
                switch ((_context23.prev = _context23.next)) {
                  case 0:
                    ...
                    (_ref21 = authprops || {}),
                      (_ref21$alias = _ref21.alias),
                      (alias =
                        _ref21$alias === undefined
                          ? sessionStorage.getItem("user")
                          : _ref21$alias),
                      (pIn = _ref21.pin); // @mhelander what is pIn?
                                ...
                                while (1) {
                                  switch ((_context19.prev = _context19.next)) {
                                    case 0:
                                      ...
                                      checkNotExpired = function checkNotExpired(
                                        args
                                      ) {
                                        if (
                    ...
                    readAndDecrypt = (function() {
                      var _ref24 = _asyncToGenerator(
                        /*#__PURE__*/ regeneratorRuntime.mark(
                          function _callee20(data, pub, key) {
                            return regeneratorRuntime.wrap(
                                ...
                                while (1) {
                                  switch ((_context20.prev = _context20.next)) {
                                    ...
                                    case 4:
                                      ...
                                      _context20.t3 = key;
                                      _context20.next = 8;
                                      return _context20.t1.decrypt.call(
                                        _context20.t1,
                                        _context20.t2,
                                        _context20.t3
                                      );
                                        ...
                                        switch (
                                          ...
                                          case 0:
                                            readStorageData = (function() {
                                              ...
                                              return function readStorageData(
                                                _x53
                                              ) {
                                                return _ref32.apply(
                                                  this,
                  ...
                  case 50:
                    ...
                    (_ref28 = _context23.t5 || {}),
                      (_ref28$err = _ref28.err),
                      (_err = _ref28$err === undefined ? "" : _ref28$err);
                    throw {
                      err:
                        "Finalizing new password login failed! Reason: " + _err
                    };
  ...
  USE(function(module) {
    ...
    var authLeave = (function() {
      var _ref33 = _asyncToGenerator(
        /*#__PURE__*/ regeneratorRuntime.mark(function _callee24(gunRoot) {
          var alias =
            arguments.length > 1 && arguments[1] !== undefined
              ? arguments[1]
              : gunRoot._.user._.alias;
          var user;
          return regeneratorRuntime.wrap(
  ...
  USE(function(module) {
    ...
    User.prototype.create = function(username, pass, cb, opt) {
      ...
      gunRoot.get("~@" + username).get(
        (function() {
          var _ref34 = _asyncToGenerator(
            /*#__PURE__*/ regeneratorRuntime.mark(function _callee25(at, ev) {
              var err,
                salt,
                proof,
                pairs,
                ...
                function _callee25$(_context25) {
                  while (1) {
                    switch ((_context25.prev = _context25.next)) {
                      ...
                      case 28:
                        _context25.next = 30;
                        return SEA.encrypt({ priv: priv, epriv: epriv }, proof)
                          .then(
                            function(auth) {
                              return (
                                // TODO: So signedsalt isn't needed?
                          ...
                          .catch(function(e) {
                            Gun.log("SEA.en or SEA.write calls failed!");
                            cat.ing = false;
                            gun.leave();
                            reject(e);
                          });
                      ...
                      case 30:
                        ...
                        gunRoot
                          .get("~@" + username)
                          .put(Gun.obj.put({}, tmp, Gun.val.link.ify(tmp)));
    ...
    User.prototype.auth = function(alias, pass, cb, opt) {
      ...
      if (cat.ing) {
        cb({
          err: "User is already being created or authenticated!",
          wait: true
        });
        return gun;
      }
                ...
                while (1) {
                  switch ((_context26.prev = _context26.next)) {
                    ...
                    case 7:
                      ...
                      err = {
                        err:
                          "Auth attempt failed! Reason: No session data for alias & PIN"
                      };
                      return _context26.abrupt(
                        "return",
                        ((cat.ing = false), gun.leave(), cb(err), gun)
                      );
                ...
                switch ((_context27.prev = _context27.next)) {
                  ...
                  case 3:
                    ...
                    return _context27.abrupt(
                      "return",
                      putErr("Auth attempt failed!")({ message: "No keys" })
                    );
                  ...
                  case 21:
                    ...
                    login.catch(
                      putErr("Failed to finalize login with new password!")
                    );
                    cat.ing = false;
                    _context27.t0 = cb;
                    _context27.next = 30;
                  ...
                  case 35:
                    ...
                    return _context27.abrupt(
                      "return",
                      putErr("Password set attempt failed!")(_context27.t2)
                    );
                  ...
                  case 51:
                    ...
                    return _context27.abrupt(
                      "return",
                      putErr("Auth attempt failed!")(_context27.t5)
                    );
    ...
    User.prototype.leave = _asyncToGenerator(
    ...
    User.prototype.delete = (function() {
      var _ref38 = _asyncToGenerator(
        /*#__PURE__*/ regeneratorRuntime.mark(function _callee29(alias, pass) {
              ...
              while (1) {
                switch ((_context29.prev = _context29.next)) {
                  ...
                  case 8:
                    ...
                    (_gunRoot$_$user = gunRoot._.user),
                      (user =
                        _gunRoot$_$user === undefined
                          ? { _: {} }
                          : _gunRoot$_$user);
    ...
    User.prototype.recall = function(setvalidity, options) {
      ...
      try {
        ...
        authsettings.hook =
          Gun.obj.has(opts, "hook") && typeof opts.hook === "function"
            ? opts.hook
            : _initial_authsettings.hook(
    ...
    User.prototype.alive = _asyncToGenerator(
      /*#__PURE__*/ regeneratorRuntime.mark(function _callee31() {
        var gunRoot, err;
        return regeneratorRuntime.wrap(
    ...
    User.prototype.trust = (function() {
      var _ref41 = _asyncToGenerator(
        /*#__PURE__*/ regeneratorRuntime.mark(function _callee32(user) {
          return regeneratorRuntime.wrap(
    ...
    User.prototype.grant = function(to, cb) {
      ...
      _asyncToGenerator(
        /*#__PURE__*/ regeneratorRuntime.mark(function _callee33() {
    ...
    User.prototype.secret = function(data, cb) {
      ...
      _asyncToGenerator(
        /*#__PURE__*/ regeneratorRuntime.mark(function _callee34() {
          var enc, sec;
          return regeneratorRuntime.wrap(
      ...
      if (msg.put) {
        ...
        each.way = function(val, key) {
          ...
          if (
            ...
            each.pub(val, key, node, soul, tmp, msg.user);
            return;
          }
          each.any(val, key, node, soul, msg.user);
          return;
